  ...
  return (
    <div className="group relative flex items-center gap-1.5 rounded-lg border bg-background px-3 py-2 text-sm transition-all hover:bg-accent hover:shadow-sm">
      ...
      <button
        ...
        className="absolute -right-1.5 -top-1.5 flex h-5 w-5 cursor-pointer items-center justify-center rounded-full bg-rose-400 text-white opacity-0 shadow-sm transition-opacity group-hover:opacity-100 focus:opacity-100"
      >
        <X className="h-3 w-3" />
      </button>
    </div>
